...
\noindent Kuwahara applied on top of V4 base (L5 configuration). K1 is the unfiltered V4 reference. Sector count excluded (no perceptible difference across its range). Tested values: 2, 5, 8. No visible difference was observed above kernel size~8.
