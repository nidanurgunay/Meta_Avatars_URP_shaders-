...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west, font=\normalsize\sffamily, text=white!80]
    at ($(current page.north west)+(1.0,-3.4)$) {Mori 1970 \textbullet{} MacDorman \& Ishiguro 2006 \textbullet{} Ho \& MacDorman 2010};
  \node[anchor=north west, font=\normalsize\sffamily, text=white!80]
    at ($(current page.north west)+(1.0,-4.1)$) {McDonnell et al.\ 2012 \textbullet{} Dill et al.\ 2012 \textbullet{} Seymour et al.\ 2021};
...
%% Dill et al. 2012
%% ═══════════════════════════════════════════════════════════════════════════
\begin{frame}{Dill et al. (2012) \textnormal{\normalsize --- Evaluation of the Uncanny Valley in CG Characters}}
\begin{center}
\begin{tikzpicture}[x=1cm, y=1cm]
\fill[kblue!70] (0.0,0.0) rectangle (3.5,6.6);
\node[font=\small\sffamily\bfseries, text=white, align=center, text width=3.1cm]
  at (1.75,5.82) {Dill et al.\\(2012)};
\draw[white!30, line width=0.3pt] (0.2,5.00) -- (3.3,5.00);
\node[font=\tiny\sffamily, text=white!85, align=center, text width=3.0cm]
  at (1.75,4.25) {10 CG characters from recent movies and games; two-stage questionnaire (still images and video); human-likeness vs familiarity ratings};
\fill[white!20, rounded corners=2pt] (0.2,0.35) rectangle (3.3,1.10);
\node[font=\tiny\sffamily\bfseries, text=white, align=center]
  at (1.75,0.72) {IVA 2012 poster\\3-page paper};
\node[font=\small\sffamily\bfseries\color{kblue!70}] at (8.72,6.42) {Key Findings};
\draw[kblue!30, line width=0.3pt] (3.65,6.10) -- (13.8,6.10);
\fill[kblue!10, rounded corners=3pt] (3.65,5.20) rectangle (13.8,6.00);
\node[font=\tiny\sffamily\color{kblue!80}, anchor=west, text width=9.65cm]
  at (3.80,5.60) {\textbf{Valley confirmed for CG characters:} Mori's familiarity curve was replicated for contemporary movie and game CG characters in both still images and video stimuli};
\fill[kblue!10, rounded corners=3pt] (3.65,4.35) rectangle (13.8,5.15);
\node[font=\tiny\sffamily\color{kblue!80}, anchor=west, text width=9.65cm]
  at (3.80,4.75) {\textbf{Motion deepens the valley:} the uncanny response was stronger for animated than still-image characters, consistent with Mori's original motion hypothesis};
\fill[kblue!10, rounded corners=3pt] (3.65,3.50) rectangle (13.8,4.30);
\node[font=\tiny\sffamily\color{kblue!80}, anchor=west, text width=9.65cm]
  at (3.80,3.90) {\textbf{Eyes and mouth cause most discomfort:} the primary sources of unease were the two most expressive and detail-dependent facial regions};
\fill[kgreen!12, draw=kgreen!40, rounded corners=3pt, line width=0.6pt]
  (3.65,0.1) rectangle (13.8,3.40);
\node[font=\small\sffamily\bfseries\color{kgreen!70!black}, anchor=west]
